class Pippin < Formula
  ...
  url "https://github.com/mattwag05/pippin/releases/download/v0.37.0/pippin-0.37.0-arm64-macos.tar.gz"
  version "0.37.0"
  sha256 "b7d9d6abc90150fe6e89714df92ed211734a218f38aa6b2ba3e1d050902eae69"
  license "Apache-2.0"
